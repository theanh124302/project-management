...
public class EventController {
    ...
    public ResponseEntity<ResponseTemplate<List<EventDTO>>> findAllByProjectId(@RequestParam Long projectId, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "200") int size) {
